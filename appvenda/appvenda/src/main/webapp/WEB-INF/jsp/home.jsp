...
<body>
	<nav class="navbar navbar-expand-sm bg-dark navbar-dark">
		<div class="container-fluid">
			<ul class="navbar-nav">
				...
				<li class="nav-item"><a class="nav-link" href="/veiculo/lista">Veiculos</a>
				</li>
			</ul>
	...
	<div class="container mt-3">
		...
		<span class="badge rounded-pill bg-primary">Vendedor:
			...
			${qtdProduto}</span> <span class="badge rounded-pill bg-success">Jogos:
			${qtdJogo}</span> <span class="badge rounded-pill bg-danger">Veiculos:
			${qtdVeiculo}</span>
